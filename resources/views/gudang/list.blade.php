              ...
              <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown"><a href="javascript: void(0)" data-toggle="dropdown" class="dropdown-toggle">Barang Masuk <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                    <li class="dropdown-item"><a href="contact.html" class="nav-link">Olat Barang Masuk</a></li>
                    <li class="dropdown-item"><a href="contact2.html" class="nav-link">Catat Barang Masuk</a></li>
                  </ul>
                </li>
                ...
                <li class="nav-item dropdown"><a href="javascript: void(0)" data-toggle="dropdown" class="dropdown-toggle">Barang Keluar <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                    <li class="dropdown-item"><a href="contact.html" class="nav-link">Olat Barang Keluar</a></li>
                    <li class="dropdown-item"><a href="contact2.html" class="nav-link">Catat Barang Keluar</a></li>
                  </ul>
                </li>

                <li class="nav-item dropdown"><a href="javascript: void(0)" data-toggle="dropdown" class="dropdown-toggle">Barang <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                    <li class="dropdown-item"><a href="contact.html" class="nav-link">Olah Data Barang</a></li>
                  </ul>
                </li>
